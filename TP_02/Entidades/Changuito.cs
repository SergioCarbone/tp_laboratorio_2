...
namespace Entidades_2017
{
    ...
    public class Changuito
    {
        ...
        public string Mostrar(Changuito c, ETipo tipo) //quitar static
        {
            ...
            sb.AppendFormat("Tenemos {0} lugares ocupados de un total de {1} disponibles", c._productos.Count, c.capacidad);
            sb.AppendLine("");
